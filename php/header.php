  <?php
    ...
    <script>
      ...
      $apply = document.getElementById("apply").values;
    </script>
    ...
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <?php if (!$isLoggedIn): ?>
        <div class="space-x-3 hidden lg:flex">
          <a href="login.php">
            <button class="border border-[#800000] text-[#800000] px-4 py-2 rounded hover:bg-[#800000] hover:text-white transition">
              Login
            </button>
          </a>

          <a href="applyNow.php">
            <button class="bg-[#800000] text-white px-4 py-2 rounded hover:bg-[#660000] transition">
              Apply Now
            </button>
          </a>
        </div>
